...
export class AppRouteNames {
  ...
  public static ExpenseType = "expensetypes";
  public static Station = "outlets";
  public static Outlet = "outlets";
  public static Nozzle = "nozzles";
  ...
  public static FuelPump = "nozzles";
  public static OutletSales = "outletsales";
  public static Stocks = "stocks";
  public static StockManagement = "stock-mgt";
  public static StockAdjustment = "stock-adjustment";
...
export class Privileges {
  ...
  public static ProductCreate = "Product.Create";
  public static ProductUpdate = "Product.Update";
  public static ProductRead = "Product.Read";
  public static ProductDelete = "Product.Delete";
  ...
  public static TransactionCreate = "Transaction.Create";
  public static TransactionUpdate = "Transaction.Update";
  public static TransactionRead = "Transaction.Read";
  public static TransactionDelete = "Transaction.Delete";
  ...
  public static OutletSalesCreate = "OutletSales.Create";
  public static OutletSalesUpdate = "OutletSales.Update";
  public static OutletSalesRead = "OutletSales.Read";
  public static OutletSalesDelete = "OutletSales.Delete";
  ...
  public static StockCreate = "Stock.Create";
  public static StockUpdate = "Stock.Update";
  public static StockRead = "Stock.Read";
